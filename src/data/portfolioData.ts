...
export const organizationData = [
  {
    organization: "Informatics Sports Week Committee",
    position: "Decoration and Equipment Member",
    period: "Sep 2023",
    responsibilities: [
      "Built event gate structure",
      "Arranged and prepared equipment for competitions"
    ]
  }
];
